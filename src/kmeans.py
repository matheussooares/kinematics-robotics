...
from kinematicsrobotics.machinelearning.model import Cluster
...
kmeans.save(
    columns = ['p_x','p_y','p_z'],
    path_data_centers = r'src\data\splits\data-r1cm-split-local\centers.csv',
    path_data_cluster = r'src\data\splits\data-r1cm-split-local\cluster.csv',
)
